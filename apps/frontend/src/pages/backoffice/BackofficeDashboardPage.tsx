...
import { Building2, FileText, Users, Loader2, ArrowRight } from 'lucide-react';
...
export function BackofficeDashboardPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl font-bold text-slate-800 mb-2">Dashboard gestion</h1>
      <p className="text-slate-600 mb-8">Vue d’ensemble des clients et de la facturation.</p>
